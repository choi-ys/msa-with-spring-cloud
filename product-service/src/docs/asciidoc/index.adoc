= Product Service API Guide Document
[choi.ys];
:doctype: book
:icons: font
...
| DEV | dev-product-service.ecommerce.io

| STG | stg-product-service.ecommerce.io

| SANDBOX | sandbox-product-service.ecommerce.io

| PRD | product-service.ecommerce.io
|===
...
operation::product-query-controller-test/find-all-by-page-request[snippets='response-body,response-fields']
...
operation::product-query-controller-test/find-by-id_fail_cause_not-exist[snippets='response-fields']

WARNING: ** 예를 들어, 존재하지 않는 상품 조회 요청 시, 다음과 같은 `404 Not Found` 응답을 반환합니다.
**

operation::product-query-controller-test/find-by-id_fail_cause_not-exist[snippets='http-request,http-response']
...
----
Product API는 사용자 관련 API Interface를 제공 합니다.
----

[[resources-product-detail]]
=== ** 상품 상세 조회 : `*GET*` Product Detail **

====
`*GET*` 요청을 사용하여 상품 상세 정보를 조회할 수 있습니다.

operation::product-query-controller-test/find-by-id[snippets='http-request,request-headers,path-parameters,http-response,response-headers,response-fields']

====

[[resources-product-list]]
=== ** 상품 목록 검색 : `*GET*` Product List **

====
`*GET*` 요청을 사용하여 상품 목록을 조회할 수 있습니다.

operation::product-query-controller-test/find-all-by-page-request[snippets='http-request,request-headers,request-parameters,http-response,response-headers,response-fields']
